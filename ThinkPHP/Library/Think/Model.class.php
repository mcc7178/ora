...
class Model
{
    ...
    protected function _checkTableInfo()
    {
        ...
        if (empty($this->fields)) {
            ...
            if (C('DB_FIELDS_CACHE')) {
                ...
                //$fields = F('_fields/' . strtolower($this->getTableName()),'','',true);

                $file_name = DATA_PATH."_fields/". strtolower($this->getTableName()).".php";
    ...
    public function flush()
    {
        ...
        if (C('DB_FIELDS_CACHE')) {
            // 永久缓存数据表信息
            F('_fields/' . strtolower($tableName), $this->fields,DATA_PATH,true);
        }
    }
