...
class UserImportController extends AdminBaseController{
	...
	public function import(){
		...
		$titleOne = array("区域","部门","室","姓名","性别","生日","年龄","邮箱","序列类型","职务/岗位","职级","用户组级别","学历","入集团日期","入中心日期","手机","办公电话","IP电话");				
