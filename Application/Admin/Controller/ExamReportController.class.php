...
class ExamReportController extends AdminBaseController{
    ...
    public function exportSurvey(){
        ...
        $data = $model->getSurveyList($total_page,1);
        ...
        foreach($data['list'] as $k=>$list){
            ...
            $items[$k]['project_name'] = $list['project_name'] ? $list['project_name'] : '---';
            $items[$k]['username'] = $list['username'] ? $list['username'] : '---';
