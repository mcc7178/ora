	...
	public function file_update(){
		...
		if (IS_POST) {
			...
			$config = array(
				'maxSize' => 999999999,
				'savePath' => '',
				'rootPath'     => './Upload/resources/',
				'saveName' => array('uniqid', ''),
				'exts' => array('doc','docx','jpg', 'gif', 'png', 'jpeg','mp3','mp4','zip','pptx','ppt','xls','xlsx','pdf','avi','wmv'),
				'autoSub' => true,
				'subName' => array('date', 'Ymd'),
			);
			...
			if (!$info) {
				...
				$url_src = "http://".$_SERVER['HTTP_HOST']."/Upload/resources/";

				$src = ['src' => $url_src.$info['file']['savepath'] . $info['file']['savename']];
