			...
			foreach ($publicCourse as $key=>$value){
				...
				if(strtolower(C('DB_TYPE')) == 'oracle'){
					$project_course = M("project_course a")->field("a.project_id,a.start_time,a.end_time")
						...
						->where("a.course_id=".$value["id"]." and (b.type=4 or b.type=0) and a.start_time>to_date('".date("Y-01-01 00:00:00")."','yyyy-mm-dd hh24:mi:ss')")->select();
