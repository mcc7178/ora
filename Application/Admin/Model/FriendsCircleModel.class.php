    ...
    */
     public function add()
	 {
       ...
       if($type == 'public'){
           ...
           preg_match_all("/\<img.*?src\=\"(.*?)\"[^>]*>/i",$content,$pat_array);
        //    dump($pat_array);  exit;
	   ...
	   if($orderno_data['status'] == 0) $data['status'] = 1;   //判断是否需要审核

       $data['content'] = preg_replace("/&lt;[\/]?[a-z-A-Z]+&gt;/is","",$data['content']);
    ...
    */
     public function getlist()
	 {
       ...
       if($_SESSION['user']['id'] == 1){
	   	...
	   	if(strtolower(C('DB_TYPE')) == 'oracle'){
			$field = "b.username,b.avatar,a.id,a.user_id,to_char(a.content) as content,a.images,a.status,a.pid,a.state,a.orderno,a.objection";
