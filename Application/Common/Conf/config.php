...
//***********************************URL设置**************************************
    ...
    'MODULE_ALLOW_LIST'      => array('Home','Admin','Mobile','Api','User','App','Scorm'), //允许访问列表
...
//***********************************163邮件服务器**********************************
    ...
    //***********************************qq邮件服务器**********************************
    'EMAIL_FROM_NAME'        => '培训平台消息中心',   // 发件人
    'EMAIL_SMTP'             => 'smtp.exmail.qq.com',   // smtp
    'EMAIL_USERNAME'         => 'phpceshi@occupationedu.com',   // 账号
    'EMAIL_PASSWORD'         => 'moye7BUL4rHQ4rQF',   // 密码  注意: 163和QQ邮箱是授权码；不是登录的密码
    'EMAIL_SMTP_SECURE'      => 'ssl',   // 链接方式 如果使用QQ邮箱；需要把此项改为  ssl  php.ini需开启拓展extension=php_openssl.dll
...
//***********************************缓存设置**********************************
    ...
    'ALIPAY_CONFIG' => array(
        ...
        'notify_url' => '/Api/Alipay/alipay_notify', // 异步接收支付状态通知的链接
        'return_url' => '/Api/Alipay/alipay_return', // 页面跳转 同步通知 页面路径 支付宝处理完请求后,当前页面自 动跳转到商户网站里指定页面的 http 路径。 (扫码支付专用)
...
//***********************************全局设置 GET，POST过滤函数**********************************
    ...
    //***********************************app极光推送(20171017添加)****************************************************
    "JPush" => array(
        'app_key' => 'a57d59c9d0aac4c4263a0b5c',//推送唯一标识
        'master_secret' => '2efb32765ab55e7d8d979cd5',//推送秘钥
    )
);
